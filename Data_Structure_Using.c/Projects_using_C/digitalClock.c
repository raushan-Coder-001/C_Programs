...
{
    int  h,m,s;
    int d=1; // we add a delay of 1000 milliseconds and we will use it in the function sleep.
    printf("Set time : \n");
    scanf("%d%d%d",&h,&m,&s);
    if(h>12 || m>60 ||s>60)
    {
    ...
    while(1) //this is an infinite loop and  anything inside will repeat itself to infinity.
    {
        ...
        sleep(d);//this function sleep slow down the while loop and make it more like a real clock
